...
void AbyssEngine::SDL2::SDL2Texture::SetYUVData(const AbyssEngine::Rectangle &rect, std::span<uint8_t> yPlane, int yPitch, std::span<uint8_t> uPlane,
                                                int uPitch, std::span<uint8_t> vPlane, int vPitch) {
